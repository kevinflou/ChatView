...
public class CarouselAdapter extends RecyclerView.Adapter<CarouselAdapter.CarouselViewHolder> {
    ...
    public void onBindViewHolder(CarouselAdapter.CarouselViewHolder holder, int position) {
        ...
        holder.itemView.setLayoutParams(new ViewGroup.LayoutParams(holder.itemView.getLayoutParams().WRAP_CONTENT,holder.itemView.getLayoutParams().MATCH_PARENT));
        holder.itemView.setOnClickListener(CarouselCellList.get(position).getOnClickListener());
    }
