...
public class MessageAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
                                                        ...
                                                        if (viewType == 997) {
                                                            ...
                                                            if (viewType == 996) {
                                                                ...
                                                                if (viewType == 995) {
                                                                    ...
                                                                    if(viewType == 1000){
                                                                        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.help_bot_layout,parent,false);
                                                                        viewHolder = new HelpBotViewHolder(view);
                                                                    }else {
                                                                        View view = LayoutInflater.from(parent.getContext())
    ...
    protected class HelpBotViewHolder extends RecyclerView.ViewHolder {
        public CardView tuto1,tuto2,tuto3,tuto4;

        public HelpBotViewHolder(View view) {
            super(view);
            tuto1 = view.findViewById(R.id.tuto1);
            tuto2 = view.findViewById(R.id.tuto2);
            tuto3 = view.findViewById(R.id.tuto3);
            tuto4 = view.findViewById(R.id.tuto4);
    ...
    public void onBindViewHolder(final RecyclerView.ViewHolder holder, final int position) {
        ...
        if(holder instanceof HelpBotViewHolder){
            ((HelpBotViewHolder) holder).tuto1.setOnClickListener(message.getTuto1OnClick());
            ((HelpBotViewHolder) holder).tuto2.setOnClickListener(message.getTuto2OnClick());
            ((HelpBotViewHolder) holder).tuto3.setOnClickListener(message.getTuto3OnClick());
            ((HelpBotViewHolder) holder).tuto4.setOnClickListener(message.getTuto4OnClick());
        }else {
